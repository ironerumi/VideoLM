...
const translations: Record<Language, Translations> = {
  en: {
    ...
    fileSizeError: 'File size exceeds the 100MB limit',
    fileTypeError: 'Invalid file type. Only video files are allowed.',
    tooManyFilesError: 'Please upload only one file at a time',
    uploading: 'Uploading...',
  ...
  ja: {
    ...
    fileSizeError: 'ファイルサイズが100MBの制限を超えています',
    fileTypeError: '無効なファイル形式です。動画ファイルのみ許可されています。',
    tooManyFilesError: '一度に1つのファイルのみアップロードしてください',
    uploading: 'アップロード中...',
